...
public class FindMinPath {
    ...
    public static class CompleteBinaryTree {
        ...
        int size;
        // We record the costs of nodes in array
        int[] nodeCosts;

        public static class Node {
            int key;
            int id;
            // We avoid recalculating for other transactions by keeping the cost value for each node.
            int cost;
            Node left;
            Node right;
        ...
        private Node fillCompleteBinaryTree(Node root, int[] keys, int index) {
            //We fill the complete binary tree from left to right from top to bottom
    ...
    // Fills the node weights array with random values.
    ...
    // Fills the edge weights array with random values.
    ...
    public static int greedySolution(CompleteBinaryTree completeBinaryTree) {
        ...
        // Min cost is equal to root's cost.
        int minCost = completeBinaryTree.root.key;

        // Our starting node is the root.
        CompleteBinaryTree.Node currentNode = completeBinaryTree.root;

        // Here is the main logic of the greedy algorithm. We're going down in the direction with the smaller cost.
        while (currentNode.left != null && currentNode.right != null) { // T(n/2)
    ...
    private static int recursiveSolution(CompleteBinaryTree.Node node) {
        ...
        int leftCost = recursiveSolution(node.left); // T(n/2)
        int rightCost = recursiveSolution(node.right); // T(n/2)
